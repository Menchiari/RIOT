function scr_costumes_egyptr() {
	//generic rebels
	color=c_white;
	skin=spr_dummy_skin;
	skin_color=make_colour_hsv(random_range(10,20),90,random_range(80,180));
	...
	body=spr_dummy_body;
	body_color=make_colour_hsv(random_range(0,190),random_range(0,90),random_range(0,180));
	var strange_color=random_range(0,100);
	if strange_color<30 {body_color=make_colour_hsv(random_range(0,250),random_range(0,220),random_range(10,250));}
	...
	legs_color=make_colour_hsv(random_range(0,190),random_range(0,250),random_range(0,180));
	legs_alpha=1;
