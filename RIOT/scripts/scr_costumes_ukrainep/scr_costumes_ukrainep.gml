...
function scr_costumes_ukrainep() {
	color=c_white;
	skin=spr_dummy_skin;
	skin_color=make_colour_hsv(random_range(10,20),90,random_range(200,250));
	...
	switch(pawn_type)
	{
		...
		case 2://journalists
			...
			gear_3=choose(spr_gear_helmet_custom,spr_gear_balaclava_1,spr_gear_bag_left,spr_gear_bag_right);
			gear_3_color=choose(c_white,c_white,c_white,c_gray,c_dkgray,c_ltgray,c_black);
