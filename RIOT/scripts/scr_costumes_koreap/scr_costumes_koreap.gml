...
function scr_costumes_koreap() {
	color=c_white;
	skin=spr_dummy_skin;
	skin_color=make_colour_hsv(random_range(10,20),random_range(50,90),random_range(180,220));
	...
	head_color=make_color_hsv(random_range(5,25),random_range(0,10),random_range(0,50));
	...
	body_color=make_colour_hsv(0,0,15);
	body_alpha=1;
	...
	gear_2_color=make_colour_hsv(0,0,15);
	gear_2_alpha=1;
	gear_3=spr_gear_helmet_custom;
	gear_3_color=make_colour_hsv(0,0,15);
	gear_3_alpha=1;
	switch(pawn_type)
	{
		case 0://melee
		...
		case 2://journalists
			...
			anim_walk=choose(anim.walk_forward);
			anim_run=choose(anim.run,anim.run_charge);
			anim_escape=choose(anim.run,anim.run,anim.run,anim.run,anim.run,anim.run,anim.run,anim.run,anim.run_escape,anim.run_panic);
			...
			gear_3_color=choose(c_black);
			gear_3_alpha=choose(0,1,1,1,1,1,1,1,1);
		break;
		case 3://fast
