...
function scr_costumes_usap() {
	color=c_white;
	skin=spr_dummy_skin;
	skin_color=make_colour_hsv(random_range(10,20),random_range(70,100),random_range(50,250));
	...
	head_color=make_color_hsv(random_range(5,25),random_range(0,90),random_range(0,250));
	body=spr_uniform_custom_shortsleeves;
	body_color=make_color_hsv(220,40,20);
	body_alpha=1;
	...
	gear_3_color=make_color_hsv(220,20,10);
	gear_3_alpha=1;
	switch(pawn_type)
	{
		case 0://melee
			anim_idle=choose(anim.defense_idle,anim.defense_idle,anim.defense_idle,anim.defense_idle,anim.defense_idle,anim.defense_idle,anim.defense_idle,anim.defense_idle,anim.defense_idle,anim.defense_raise_idle,anim.idle_radio,anim.idle,anim.idle_agitated,anim.idle_angry,anim.idle_handsinpocket,anim.picture_smartphone);
			anim_walk=choose(anim.defense_walkfwd);
			anim_walk_backwards=choose(anim.defense_walkback);
		...
		case 2://journalists
			...
			body=choose(spr_uniform_greece_longsleeves,spr_uniform_greece_shortsleeves,spr_uniform_custom_longsleeves,spr_uniform_custom_shortsleeves,spr_uniform_custom_longsleeves,spr_uniform_custom_shortsleeves);
			...
			gear_3=choose(spr_gear_helmet_italy,spr_gear_helmet_italy,spr_gear_helmet_italy,spr_gear_helmet_italy,spr_gear_helmet_italy,spr_gear_helmet,spr_gear_balaclava_1,spr_gear_bag_left,spr_gear_bag_right);
			gear_3_color=choose(c_white,c_white,c_white,c_black);
