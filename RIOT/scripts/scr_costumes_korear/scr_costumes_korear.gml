function scr_costumes_korear() {
	//generic rebels
	color=c_white;
	skin=spr_dummy_skin;
	skin_color=make_colour_hsv(random_range(10,20),random_range(40,90),random_range(180,220));
	head=choose(spr_head_p_kid,spr_head_p_old,spr_head_p_thinbeard,spr_head_r_lenny2010,spr_head_r_ponytail,spr_head_rf_straight);
	head_color=make_color_hsv(random_range(5,25),random_range(0,10),random_range(10,60));
	var old=random_range(0,100)
	if old<5 {head_color=make_color_hsv(0,0,random_range(0,250));}
	body=spr_dummy_body;
	body_color=make_colour_hsv(random_range(0,190),random_range(0,150),random_range(0,100));
	...
	legs_color=make_colour_hsv(random_range(0,190),random_range(0,50),random_range(0,100));
	legs_alpha=1;
	...
	switch(pawn_type)
	{
		...
		case 1://ranged
			...
			gear_3_color=make_colour_hsv(random_range(0,250),random_range(0,50),random_range(0,120));
			gear_3_alpha=1;
		break;
		case 2://journalists
		...
		case 3://fast
			...
			anim_run=choose(anim.run,anim.run_charge);
			anim_escape=choose(anim.run_escape,anim.run_panic);
			anim_attack=choose(anim.atk_kick_floor,anim.atk_kick_high,anim.atk_knee,anim.atk_punch_high,anim.atk_punch_low,anim.taunt_fuckyou,anim.taunt_finger,anim.taunt_megaphone_1,anim.taunt_megaphone_2,anim.taunt_backpack,anim.taunt_clap_high);
		
			gear_3=choose(spr_gear_balaclava_1,spr_gear_helmet,spr_gear_helmet,spr_gear_helmet,spr_gear_elbows,spr_gear_kefia);
			gear_3_color=c_black;
			gear_3_alpha=1;
		break;
		default:
		break;
