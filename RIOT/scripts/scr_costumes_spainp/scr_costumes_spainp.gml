...
function scr_costumes_spainp() {
	color=c_white;
	skin=spr_dummy_skin;
	skin_color=make_colour_hsv(random_range(10,20),90,random_range(100,200));
	...
	var old=random_range(0,100)
	if old<5 {head_color=make_color_hsv(0,0,random_range(200,250));}
	body=spr_uniform_custom_longsleeves;
	body_color=make_colour_hsv(180,125,35);
	body_alpha=1;
	...
	gear_2_color=c_dkgray;
	gear_2_alpha=1;
	gear_3=spr_gear_helmet_heavy_custom;
	gear_3_color=make_colour_hsv(180,125,35);
	gear_3_alpha=1;
	switch(pawn_type)
	{
		case 0://melee
			anim_idle=choose(anim.defense_idle,anim.defense_raise_idle,anim.idle,anim.idle_agitated,anim.idle_angry,anim.idle_handsinpocket,anim.idle_smoke,anim.picture_smartphone);
			anim_walk=choose(anim.defense_walkfwd,anim.walk_forward,anim.walk_angry,anim.walk_boss);
			anim_walk_backwards=anim.defense_walkback;
			anim_run=choose(anim.run,anim.run_charge);
			anim_escape=choose(anim.run,anim.run,anim.run,anim.run_escape,anim.run_escape,anim.run_panic);
			...
			body=spr_uniform_custom_longsleeves;
			gear_2=spr_gear_shield;
			gear_2_color=make_colour_hsv(180,125,35);
			gear_2_alpha=1;
		break;
		case 1://ranged
			...
			gear_2_alpha=1;
			gear_3=choose(spr_gear_balaclava_1,spr_gear_balaclava_1,spr_gear_balaclava_1,spr_gear_balaclava_1,spr_gear_bag_right);
			gear_3_color=choose(c_white,c_white,c_white,c_white,c_white,c_white,c_white,c_white,c_gray,c_black);
			gear_3_alpha=choose(0,1,1,1,1);
		break;
		case 2://journalists
			...
			legs=spr_dummy_body;
			legs_color=make_colour_hsv(random_range(0,190),random_range(0,90),random_range(0,180));//make_colour_hsv(random_range(0,190),random_range(0,40),random_range(10,90));
			legs_alpha=choose(0,1,1);
			...
			gear_3=choose(spr_gear_helmet_italy,spr_gear_helmet,spr_gear_helmet_custom,spr_gear_balaclava_1,spr_gear_bag_left,spr_gear_bag_right);
			gear_3_color=choose(c_white,c_black,c_white,c_black,make_colour_hsv(random_range(0,150),random_range(0,90),random_range(0,250)));
			gear_3_alpha=choose(0,1,1,1,1);
		break;
		case 3://fast
