...
function scr_editor_costumes_rebels(){
	
if room==rm_rotterdam //change to room that you want
{
	//generic rebels
	color=c_white;
	skin=spr_dummy_skin;
	...
	body=spr_dummy_body;
	body_color=make_colour_hsv(random_range(0,180),random_range(0,90),random_range(0,100));
	...
	legs_color=make_colour_hsv(random_range(0,190),random_range(0,90),random_range(0,180));
	legs_alpha=1;
