...
function scr_editor_costumes_police(){
if room==rm_rotterdam
{
	//editor police	
	color=c_white;
	skin=spr_dummy_skin;
	skin_color=make_colour_hsv(random_range(10,20),90,random_range(150,200));
	...
	body_color=c_dkgray;
	body_alpha=1;
	vest=spr_dummy_vest; //choose(spr_gear_bag_left,spr_gear_bag_right,spr_gear_elbows,spr_gear_kneepads);
	vest_color=make_color_rgb(138,250,24);
	vest_alpha=choose(0,1,1,1,1,1);
	...
	gear_2_alpha=1;
	gear_3=spr_gear_helmet_custom;
	gear_3_color=c_dkgray;
	gear_3_alpha=1;

	switch(pawn_type)
	{
		case 0://melee
			anim_idle=choose(anim.defense_idle,anim.defense_raise_idle,anim.defense_idle,anim.defense_raise_idle,anim.idle,anim.idle_agitated,anim.idle_angry,anim.idle_handsinpocket,anim.idle_smoke,anim.picture_smartphone);
			anim_walk=choose(anim.walk_forward,anim.walk_angry,anim.walk_boss,anim.defense_walkfwd);
			...
			body=spr_uniform_italy_longsleeves;
			gear_2=spr_gear_shield;
			gear_2_color=c_ltgray;
			gear_2_alpha=.5;
		break;
