...
function scr_costumes_greecep() {

	////greek police
	color=c_white;
	skin=spr_dummy_skin;
	skin_color=make_colour_hsv(random_range(10,20),90,random_range(180,250));
	...
	head_color=make_color_hsv(random_range(5,25),random_range(0,10),random_range(0,100));
	...
	switch(pawn_type)
	{
		case 0://melee
			...
			body=spr_uniform_greece_longsleeves;
			gear_2=spr_gear_shield;
			gear_2_color=c_ltgray;
			gear_2_alpha=.5;
		break;
		...
		case 2://journalists
			...
			gear_3=choose(spr_gear_helmet,spr_gear_balaclava_1,spr_gear_bag_left,spr_gear_bag_right);
