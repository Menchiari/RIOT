function scr_costumes_greecer() {
	//generic rebels
	color=c_white;
	skin=spr_dummy_skin;
	skin_color=make_colour_hsv(random_range(10,20),90,random_range(150,250));
	head=choose(spr_head_p_beard,spr_head_p_beard2,spr_head_p_kid,spr_head_p_old,spr_head_p_pizzetto,spr_head_p_stash,spr_head_p_thinbeard,spr_head_r_beardlong,spr_head_r_lenny2010,spr_head_r_ponytail,spr_head_rf_moved,spr_head_rf_red,spr_head_rf_short,spr_head_rf_straight);
	head_color=make_color_hsv(random_range(5,25),random_range(10,0),random_range(0,250));
	body=spr_dummy_body;
	body_color=make_colour_hsv(random_range(0,190),random_range(0,90),random_range(0,90));
	...
	legs_color=make_colour_hsv(random_range(0,190),random_range(0,90),random_range(10,180));
	legs_alpha=1;
	...
	switch(pawn_type)
	{
		...
		case 1://ranged
			...
			if strange_color<3 {gear_3_color=make_colour_hsv(random_range(0,250),random_range(0,220),random_range(10,250));}
			gear_3_alpha=1;
		break;
		case 2://journalists
