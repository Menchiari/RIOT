...
function scr_costumes_egyptp() {
	color=c_white;
	skin=spr_dummy_skin;
	skin_color=make_colour_hsv(random_range(10,20),90,random_range(80,150));
	...
	switch(pawn_type)
	{
		case 0://melee
			...
			anim_attack=choose(anim.atk_kick_floor,anim.atk_kick_high,anim.atk_knee,anim.atk_punch_high,anim.atk_punch_low,anim.atk_kick_floor,anim.atk_kick_high,anim.atk_knee,anim.atk_punch_high,anim.atk_punch_low,anim.picture_smartphone,anim.taunt_fuckyou,anim.taunt_finger,anim.taunt_mooning,anim.taunt_suckit,anim.taunt_whatup,anim.idle_radio);
		...
		case 3://fast
			...
			gear_2_color=choose(c_black,c_gray);
			gear_2_alpha=1;
		break;
		default:
		break;
