function scr_costumes_turkeyr() {
	...
	body=spr_dummy_body;
	body_color=make_colour_hsv(random_range(0,190),random_range(0,190),random_range(0,180));
	...
	legs_color=make_colour_hsv(random_range(0,250),random_range(0,160),random_range(0,220));
	legs_alpha=1;
	gear_1=spr_gear_kefia;
	gear_1_color=make_colour_hsv(random_range(0,250),random_range(0,90),random_range(40,220));
	...
	gear_2_color=make_colour_hsv(random_range(0,250),random_range(0,90),random_range(40,220));
	...
	switch(pawn_type)
	{
		...
		case 2://journalists
			...
			gear_1_color=merge_color(c_gray,choose(c_black,c_orange,c_dkgray,c_ltgray,c_maroon,c_navy,c_olive,c_white,c_gray,c_red,c_yellow),random_range(0,1));
