...
anim_attack=choose(anim.idle_bumped_left,anim.idle_bumped_right,anim.defense_idle,anim.hands_up_idle,anim.hit_scared,anim.hit_back,anim.hit_front,anim.hit_front_face,anim.hit_front_stomach,anim.hit_puke);
