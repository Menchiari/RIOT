///@description Rebels Wall Unit Setup
scr_costumes_rebels();

//this is so that wall stays still and not distracting
anim_idle=choose(anim.idle,anim.idle,anim.idle,anim.idle,anim.idle_agitated,anim.idle_angry,anim.idle_handsinpocket,anim.idle_smoke);
...
if room=rm_occupy
{
	anim_idle=choose(anim.idle,anim.idle,anim.idle,anim.idle_agitated,anim.idle_angry,anim.idle_handsinpocket);
}